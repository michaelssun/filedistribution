...
public abstract class AbstractFtpSessionFactory<T extends FTPClient> implements SessionFactory<FTPFile> {
	...
	protected String controlEncoding = org.apache.commons.net.ftp.FTPClient.DEFAULT_CONTROL_ENCODING;
	...
	public void setClientMode(int clientMode) {
		Assert.isTrue(clientMode == org.apache.commons.net.ftp.FTPClient.ACTIVE_LOCAL_DATA_CONNECTION_MODE ||
				clientMode == org.apache.commons.net.ftp.FTPClient.PASSIVE_LOCAL_DATA_CONNECTION_MODE,
